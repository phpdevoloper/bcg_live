...
<div class="about">
    ...
    <div class="section">
        <h3 class="text-center txt" style="color: #299adc;">Major Events (Archived)</h3>
    </div>
                ...
                <div class="testimonial-item" style="padding-top: 20px;">
                    <!-- <div class="row">
                        ...
                        <div class="col-lg-4 text-center Groupfilter">
                            ...
                            <select class="custom-select-sm cate" id="year_drop">
                                <?php 
                                    $current_year = date('Y');
                                    $sql = "SELECT * FROM events WHERE date_part('year', date_to) < date_part('year', CURRENT_DATE);"; 
                    ...
                    <table id="example" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                        ...
                        <tbody style="font-size: 13px;">
                            <?php  $sql = "SELECT * FROM events WHERE date_part('year', date_to) < date_part('year', CURRENT_DATE) AND event_status = 'L'"; 
                            $res = pg_query($db,$sql);
