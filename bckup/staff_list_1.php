    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <?php $sql = "SELECT DISTINCT bs.*,bsd.deg_name,bsg.cate_name FROM bcgvl_staff_details bs JOIN bcgvl_staff_designation bsd ON bs.deg_code = bsd.deg_code left outer JOIN bcgvl_staff_groups bsg ON bs.cate_code = bsg.cate_code WHERE bs.status='INS' ORDER BY bs.staff_id ASC"; 
                        $res = pg_query($db,$sql);
