...
<div class="about">
    ...
    <div class="section">
        <h3 class="text-center txt" style="color: #299adc;">RTI Proactive Disclosure</h3>
    </div>
                                ...
                                ?>
                                    <div class="card-header" id="heading-<?php echo $i;?>-<?php echo $b;?>">
                                        ...
                                        <?php } else { 
                                            ...
                                            <?php }else{?>
                                                <h5 class="mb-0">
                                                    <a rel='noopener noreferrer' class="collapsed" role="button" data-toggle="collapse" href="#collapse-<?php echo $i;?>-<?php echo $b;?>" aria-expanded="false" aria-controls="collapse-<?php echo $i;?>-<?php echo $b;?>">
                                                    <?php echo $value['sub_rti_name'];?>
                                                    </a>
                                                </h5>
                                            <?php } ?>
