          ...
          <div class="card">
            ...
            <div class="page-header">
              <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="div_production.php">Laboratory Animal House</a>
                </li>
              </ul>
            </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-12 col-lg-12">
                  <div class="form-group">
                    <input type="hidden" name="content_id" id="content_id" value="LAH">
                    <textarea class="form-control" id="labhouse" rows="5">
                    </textarea>
                  </div>
                </div>
              </div>
            ...
            <div class="card-action">
              ...
              <a href="viewLAH.php" class="btn btn-danger">Cancel</a>
            </div>
          </div>
        </div>
      </div>
...
<?php include('inc/footer.php');  
 $sql    = "SELECT * FROM division WHERE div_name='LAH'";
 $res    = pg_query($db,$sql);
...
$(".updateadm").on("click", function () {
    ...
    var content = tinymce.get("labhouse").getContent();
