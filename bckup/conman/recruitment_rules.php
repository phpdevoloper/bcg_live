                            ...
                            <div class="d-flex align-items-center">
                                <div class="page-header">
                                    <ul class="breadcrumbs">
                                        <li class="nav-item">
                                            <a href="whats_new.php">Recruitment Rules</a>
                                        </li>
                                    </ul>
                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" class="form-control" name="report_cate" id="Report_cate" value="RECR">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table id="add-row"
                                                ...
                                                <tbody>
                                                    <?php $sql = "SELECT * FROM documents_bcg where doc_cate = 'RECR' ORDER BY doc_id"; 
                                                          $res = pg_query($db, $sql);
