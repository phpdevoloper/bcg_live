                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-primary btn-round ml-auto" href="tenders.php">Back</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <!-- Modal -->
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form id="edit_recruitment">
                                                                                ...
                                                                                <div class="modal-footer" style="justify-content: center !important;">
                                                                                    ...
                                                                                    class="tender_delete" style="color:red;">Delete ?</a>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
...
$(document).ready(function () {
 ...
 $(document).on("click", ".get_what", function (e) {
    ...
    $(".tender_delete").attr("data-tender_id",tender_id);
    ...
    $("#edit_recruitment").validate({
     ...
     $(".tender_delete").on('click', function(){
        var tender_id = $(this).attr("data-tender_id");
        var action = "TenderDelete";
        swal({
          title: "Are you sure?",
          text: "You want to delete this tender!",
          icon: "warning",
          buttons: ["Cancel!", "Yes"],
          dangerMode: true,
        }).then(function (isConfirm) {
