                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table id="add-row"
                                                ...
                                                <tbody>
                                                    <?php 
                                                    $sql = "SELECT DISTINCT bs.*,bsd.deg_name,bsg.cate_name
FROM bcgvl_staff_details bs JOIN bcgvl_staff_designation bsd ON bs.deg_code = bsd.deg_code 
left outer JOIN bcgvl_staff_groups bsg ON bs.cate_code = bsg.cate_code where bs.status='INS' and bs.staff_dstatus = 'L' ORDER BY cate_name ASC";
// $sql = "SELECT * FROM bcgvl_staff_details"; 
                                                          $res = pg_query($db, $sql);
                                                          $result = pg_fetch_all($res);
                                                          // var_dump($result);die;
                                                          foreach ($result as $value) {
