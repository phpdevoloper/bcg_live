                                                        ...
                                                        <div class="form-group form-inline">
                                                            ...
                                                            <div class="col-md-9 p-0">
                                                                <select class="form-control input-full" name="even_cat" id="even_cat">
                                                                    ...
                                                                    <?php 
                                                                        $sql = "SELECT * FROM video_category WHERE cate_id ='$cate_id' ORDER BY cate_id";
                                                                        $exe = pg_query($db,$sql);
                                            ...
                                            <div class="box">
                                                <div class="boxInner">
                                                    ...
                                                    <iframe width="315" height="315" src="<?php echo $value['photo_file'];?>" 
                                                        title="YouTube video player" referrerpolicy="no-referrer-when-downgrade" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen>
                                                    </iframe>
                                                </div>
                                            </div>
...
$(document).ready(function(){
    $(document).on("click", ".gallery_del", function (e) {
    e.preventDefault();
    var video_id = $(this).attr("data-video_id");
    swal({
      title: "Are you sure?",
      text: "You wants to delete this video!",
      icon: "warning",
