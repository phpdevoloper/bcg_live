...
<html lang="en">
   ...
   ini_set('session.use_only_cookies', 1);
    ...
    header("Cross-Origin-Resource-Policy: same-origin");
     ...
     header("Content-Security-Policy: default-src 'self';object-src 'none';frame-ancestors 'none';upgrade-insecure-requests;block-all-mixed-content");
      header("Content-Security-Policy: frame-src https://10.163.77.75/");

    header("Content-Security-Policy: manifest-src https://10.163.77.75/");

    header("Content-Security-Policy: connect-src https://10.163.77.75/");

     header("Content-Security-Policy: font-src https://10.163.77.75/");
  ...
  // $allowed_host = ['10.163.77.75','10.26.36.222'];
