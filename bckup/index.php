    ...
    <div class="container">
        ...
        <div class="col-lg-4 col-md-6 service_col">
            <div class="card">
                ...
                <div class="card-footer1">
                    <a rel='noopener noreferrer' href="about_bcg.php" class="more_class">More<i class="fa fa-long-arrow-alt-right"></i></a>
                </div>
            </div>
        </div>
        <!-- Service -->
        <div class="col-lg-4 col-md-6 service_col dir">
            ...
            <div class="card">
                ...
                <div class="card-footer1">
                    <a rel='noopener noreferrer' href="director_desk3.php" class="more_class">More<i class="fa fa-long-arrow-alt-right"></i></a>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 service_col">
            <div class="card">
                    ...
                    <div class="container">
                        <marquee class="what_new" onmouseover="this.stop()" onmouseout="this.start()" width="100%" direction="up" Scrollamount=4>
                            <ul class="cont">
                                 ...
                                 ?>
                                    <li>
                                        <a rel='noopener noreferrer' href="events_details.php" target="_blank">
                                ...
                                // echo $sql;
                                 ...
                                 ?>
                                    <li>
                                        <a rel='noopener noreferrer' href="uploads/recruitment/<?php echo $value['upload_advt'];?>" target="_blank">
                                            <i class="far fa-hand-point-right"></i>
                                ...
                                <?php $sql= "SELECT * FROM tenders where TO_DATE(date_of_closed,'YYYY-MM-DD') >= current_date and tender_dstatus = 'L' LIMIT 2";
                                 ...
                                 ?>
                                    <li>
                                        <a rel='noopener noreferrer' href="uploads/tenders/<?php echo $value['tenders_notice'];?>" target="_blank">
                                            <i class="far fa-hand-point-right"></i>
                ...
                <div class="card-footer1">
                    <!-- <a rel='noopener noreferrer' href="whats_new.php" class="more_class">More<i class="fa fa-long-arrow-alt-right"></i></a> -->
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-lg-9 col-md-8 service_col">
                            <div class="text-box">
                                <div class="text-container">
                                    ...
                                    <p>
                                    <?php 
                                   $small = substr($value['product_desc'], 0, 409);
                                   echo $small;
                                  ?>
                                    </p>
                                    <?php } ?>
                            ...
                            <div class="read_more">
                                <a rel='noopener noreferrer' href="product.php" class="more_class">More<i class="fa fa-long-arrow-alt-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row services_row">
        ...
        <div class="col-lg-4 col-md-6 service_col">
            <div class="card">
                ...
                <div class="card-footer1">
                    <a rel='noopener noreferrer' href="events_details.php" class="more_class">More<i class="fa fa-long-arrow-alt-right"></i></a>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 service_col">
            <div class="card">
                ...
                <div class="card-footer1">
                    <a rel='noopener noreferrer' href="recruitments.php" class="more_class">More<i class="fa fa-long-arrow-alt-right"></i></a>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 service_col">
            <a rel='noopener noreferrer' href="">
                <div class="card">
                    ...
                    <div class="card-footer1">
                        <a rel='noopener noreferrer' href="tenders.php" class="more_class">More<i class="fa fa-long-arrow-alt-right"></i></a>
                    </div>
                </div>
            </a>
        </div>
...
<div class="photo_video_gallery">
    <div class="container">
        ...
        <li>
            <a rel='noopener noreferrer' class="active" href="javaScript:void(0)" data-category="panda"
            >PHOTO</a
            >
        </li>
        <li>
            <a rel='noopener noreferrer' href="javaScript:void(0)" data-category="cat">VIDEOS</a>
        </li>
        </ul>
        <div class="slider-wrapper">
            <ul class="item-slider">
                <?php 
                   $sql = "SELECT distinct(photo_id),* FROM photo_gallery where photo_status = 'L' ORDER BY created_at DESC";
                   $res = pg_query($db,$sql);
                   $gallery = pg_fetch_all($res);
                   foreach($gallery as $value){ ?>
                        <li class="magnific-img" data-match="panda">
                            <a rel='noopener noreferrer' class="image-popup-vertical-fit" href="uploads/gallery/photo/<?php echo $value["photo_file"];?>" style="color:none;">
...
<!--                    <a rel='noopener noreferrer' class="image-popup-vertical-fit" href="<?php echo $value["photo_file"];?>">
                        <iframe width="100%" height="157" src="<?php echo $value["photo_file"];?>" title="YouTube video player" referrerpolicy="no-referrer-when-downgrade" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen>
                        </iframe>
                    </a>-->
                </li>
                <?php } ?>
        ...
        <div class="slider-controls">
            ...
            <a rel='noopener noreferrer' href="photo_gallery.php" class="view-all float-right">View All</a>
        </div>
    </div>
</div>
