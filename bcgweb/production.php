...
<div class="about">
    <section>
        <ul class="breadcrumb wizard">
            ...
            <li class=""><a href="contact.php">Production</a></li>
        </ul>
    </section>
    <div class="section">
        <h3 class="text-center txt" style="color: #299adc;background: #eef0f2;">Production</h3>
    </div>
    <div class="container aos-init aos-animate" data-aos="fade-up" style="padding-top: 38px;">
        <div class="container">
            ...
            <section id="about">
                ...
                <?php $sql = "SELECT * FROM division WHERE div_name = 'PRO' ORDER BY div_id ASC "; 
                        $res = pg_query($db,$sql);
