        ...
        <div class="col-md-12">
          <div class="card">
              ...
              <div class="row">
                <div class="col-md-12 col-lg-12">
                  <div class="form-group">
                    <input type="hidden" name="content_id" id="content_id" value="ADM">
                    <textarea class="form-control" id="administration" rows="5">
                    </textarea>
                  </div>
                </div>
              </div>
            ...
            <div class="card-action">
              ...
              <a href="viewADM.php" class="btn btn-danger">Cancel</a>
            </div>
          </div>
        </div>
      </div>
...
$(".updateadm").on("click", function () {
    ...
    var content = tinymce.get("administration").getContent();
