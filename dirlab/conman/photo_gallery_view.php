                        ...
                        <div class="card-body">
                            ...
                            <div>
                                <div class="row photo_gallery">
                                    <?php 
                                        $sql = "select distinct(photo_id),* from photo_gallery where category='$cate_id' and photo_status='L' order by photo_id DESC";
                                        $exe = pg_query($db,$sql);
                                        $result = pg_fetch_all($exe);
                                        foreach($result as $value){
                                    ?>
                                            ...
                                            <div class="modal-footer" style="justify-content: center !important;">
                                                ...
                                                <button type="button" class="btn btn-danger"
                                                    ...
                                                    <a href="javascript:void(0);" 
                                                                                    class="photo_delete" style="color:red;">Delete ?</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
<script type="text/javascript">
    $(".photo_delete").on('click', function(){
        var g_id = $(this).attr("data-g_id");
        var action = "PhotoDelete";
        swal({
          title: "Are you sure?",
