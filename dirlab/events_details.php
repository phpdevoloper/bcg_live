...
<div class="about">
    <section>
        <ul class="breadcrumb wizard">
            ...
            <li class=""><a href="events_details.php">Major Events</a></li>
        </ul>
    </section>
    <div class="container">
        <div class="section">
            <h3 class="text-center txt" style="color: #299adc;">Major Events</h3>
        </div>
        <div class="row">
            <!-- About Content -->
            <div class="col-lg-12">
                ...
                <?php $sql = "SELECT * FROM events WHERE date_to >= current_date AND event_status = 'L'"; 
                        $res = pg_query($db,$sql);
