...
<div class="about">
    <section>
        <ul class="breadcrumb wizard">
            ...
            <li class=""><a href="view_photo_gallery.php">Photo Gallery</a></li>
        </ul>
    </section>
    <div class="section">
        <h3 class="text-center txt" style="color: #299adc;"><?php 
    ...
    <section>
        <div class="container">
            <div class="row">
                <?php  
                    $sql = "select distinct(photo_id),* from photo_gallery where category='$cate_id' and photo_status='L' order by photo_id";
                    $exe = pg_query($db,$sql);
