...
<div class="about">
    <section>
        <ul class="breadcrumb wizard">
            ...
            <li class=""><a href="past_events.php">Past Events</a></li>
        </ul>
    </section>
    <div class="container">
        <div class="section">
            <h3 class="text-center txt" style="color: #299adc;">Past Events</h3>
        </div>
        <div class="row">
            <!-- About Content -->
            <div class="col-lg-12">
                ...
                <?php 
                      ...
                      $sql = "SELECT * FROM public.events where date_from < '$current_date'
