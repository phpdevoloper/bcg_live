...
<html lang="en">
  ...
  /* header ("Set-Cookie: bcgvladmin ; expires=Tue, 17-May-12 14:39:58 GMT;path=/; domain=10.163.77.75 164.100.167.84  https://dirbcglab.gov.in/");
    ...
    header("Content-Security-Policy: default-src 'nonce-rAnd0m' 'self'; object-src 'none';frame-ancestors 'none';upgrade-insecure-requests;block-all-mixed-content");
    
    header("Content-Security-Policy: frame-src 10.163.77.75 164.100.167.84 https://dirbcglab.gov.in/");

    header("Content-Security-Policy: manifest-src 10.163.77.75 164.100.167.84 https://dirbcglab.gov.in/");

    header("Content-Security-Policy: connect-src 10.163.77.75 164.100.167.84 https://dirbcglab.gov.in/");

    header("Content-Security-Policy: font-src 10.163.77.75 164.100.167.84 https://dirbcglab.gov.in/");

    header("Content-Security-Policy: img-src 10.163.77.75 164.100.167.84 https://dirbcglab.gov.in/");

    header("Content-Security-Policy: media-src 10.163.77.75 164.100.167.84 https://dirbcglab.gov.in/");
