...
if (isset($_POST['con_id']) && $_POST['con_id'] !='') {
    ...
    if(empty($errorMSG)){
        $sql = "UPDATE rti_contacts SET contact_title,user_name,designation,contact_address,user_phone,office_phone,
        organization_email = '$org_email',user_email = '$user_email') VALUES('".$_POST['con_title']."','".$_POST['con_name']."','".$_POST['designation']."'
        ,'".$_POST['office_addres']."','".$_POST['user_phone']."','".$_POST['office_phone']."',
        ,)";
        $exe = pg_query($db,$sql);
        if($exe){
