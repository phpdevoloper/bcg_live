        ...
        <div class="col-md-12">
          <div class="card">
              ...
              <div class="row">
                <div class="col-md-12 col-lg-12">
                  <div class="form-group">
                    <input type="hidden" name="content_id" id="content_id" value="QAS">
                    <textarea class="form-control" id="quality" rows="5">
                    </textarea>
                  </div>
                </div>
              </div>
            ...
            <div class="card-action">
              ...
              <a href="viewQUA.php" class="btn btn-danger">Cancel</a>
            </div>
          </div>
        </div>
      </div>
...
<?php include('inc/footer.php');  
 $sql    = "SELECT * FROM division WHERE div_name ='QAS'";
 $res    = pg_query($db,$sql);
...
$(".updateadm").on("click", function () {
    ...
    var content = tinymce.get("quality").getContent();
