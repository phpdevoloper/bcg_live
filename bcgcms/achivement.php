                                        ...
                                        <div class="modal-body">
                                            <form id="update_Basic">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="director_position"
                                                                ...
                                                                <option
                                                                    value="<?php echo $value['designation_code'] ?>">
                                                    ...
                                                    <div class="col-md-6 pr-0">
                                                        <div class="form-group">
                                                            <img class="js--image-preview" src="assets/img/profile.jpg"
                                                                alt="">
                                                            ...
                                                            <div class="form-button-action">
                                                                <button type="button" data-toggle="modal"
                                                                    ...
                                                                    <i class="fa fa-edit get_basic"
                                                                        ...
                                                                        data-dir_photo="<?php //echo $value['director_photo'];?>"></i>
                                                                </button>
                                                                <!-- Edit Modal -->
                                                                                ...
                                                                                <form id="edit_basic"
                                                                                    ...
                                                                                    <div class="modal-footer no-bd">
                                                                                        <button type="submit"
                                                                                            ...
                                                                                            name="UpdateBasic">Update</button>
                                                                                        <button type="button"
