          ...
          <div class="card">
            ...
            <div class="page-header">
              <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="div_production.php">Engineering</a>
                </li>
              </ul>
            </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-12 col-lg-12">
                  <div class="form-group">
                    <input type="hidden" name="content_id" id="content_id" value="ENG">
                    <textarea class="form-control" id="engineering" rows="5">
                    </textarea>
                  </div>
                </div>
              </div>
            ...
            <div class="card-action">
              ...
              <a href="viewENG.php" class="btn btn-danger">Cancel</a>
            </div>
          </div>
        </div>
      </div>
...
<?php include('inc/footer.php');  
 $sql    = "SELECT * FROM division WHERE div_name='ENG'";
 $res    = pg_query($db,$sql);
...
$(".updateadm").on("click", function () {
    ...
    var content = tinymce.get("engineering").getContent();
