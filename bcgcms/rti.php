                                                        ...
                                                        <div class="form-group row ">
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="RTI_file_check5" value="">
                                                                <label for="inputPassword"
                                                                    class="col-sm-4 col-form-label">URL</label>
                                                                <input class="form-check-input" type="checkbox"
                                                                    id="RTI_url_check5" value="">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-sm-12">
...
// </div>
    ...
    //   Level 1
      ...
      //   Level 5
      $("#RTI_file_check5").change(function () {
            if ($(this).is(":checked")) {
            // $("#url_check").attr("checked", false);
            $("#RTI_url_check5").prop("checked", false);
            $(".RTI_url").attr("style", "display:none");
            $(".RTI_upload").attr("style", "display:block");
            } else {
            $(".RTI_upload").attr("style", "display:none");
        ...
        $("#RTI_url_check5").change(function () {
            if ($(this).is(":checked")) {
            $("#RTI_file_check5").prop("checked", false);
            $(".RTI_upload").attr("style", "display:none");
            $(".RTI_url").attr("style", "display:block");
            } else {
            $(".RTI_url").attr("style", "display:none");
