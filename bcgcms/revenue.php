        ...
        <div class="col-md-12">
          <div class="card">
              ...
              <div class="row">
                <div class="col-md-12 col-lg-12">
                  <div class="form-group">
                    <input type="hidden" name="content_id" id="content_id" value="REV">
            ...
            <div class="card-action">
              ...
              <a href="viewREV.php" class="btn btn-danger">Cancel</a>
            </div>
          </div>
        </div>
      </div>
...
<?php include('inc/footer.php');  
 $sql    = "SELECT * FROM about_us WHERE content_id = 'REV'";
 $res    = pg_query($db,$sql);
